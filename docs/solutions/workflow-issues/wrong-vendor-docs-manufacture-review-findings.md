...
[`plugins/raycast-extensions/reference/keyboard-conventions.md:54`](/Users/messina/Developer/GitHub/chrismessina/raycast-extension-workflows/plugins/raycast-extensions/reference/keyboard-conventions.md:54)
has carried `` `Common.Pin` | ⌘ . | ctrl . `` all along, and [line 13](/Users/messina/Developer/GitHub/chrismessina/raycast-extension-workflows/plugins/raycast-extensions/reference/keyboard-conventions.md:13) records that a June snapshot had five wrong macOS bindings — naming `Pin` — and says to "regenerate rather than trusting prose docs."
...
- [Verify the remedy a review implies, not just the finding](/Users/messina/Developer/GitHub/chrismessina/raycast-extension-workflows/docs/solutions/workflow-issues/verify-the-remedy-not-just-the-finding.md) — the sibling; this amends its "pure refactor needs no check" carve-out, because there the finding was true and the remedy unchecked, and here the finding itself was false.
- [Answer a blocking review finding with a measurement](/Users/messina/Developer/GitHub/chrismessina/raycast-extension-workflows/docs/solutions/workflow-issues/answer-a-blocking-review-with-a-measurement.md) — names compliance-by-default as the failure mode; this is compliance-by-default on a finding that was itself false.
- [Grading a reverse-engineered model against the vendor release](/Users/messina/Developer/dotfiles/claude/docs/solutions/workflow-issues/grading-a-reverse-engineered-model-against-the-vendor-release.md) — its §2 ground-truth ladder puts a vendor's generated API reference on rung 2, tracking the build. This is a counterexample: a page presenting as generated-per-release, wrong about the value, and regressing after correction. Strengthen that corollary from "lags" to "can contradict, and can revert".
- [Read the version off the running artifact](/Users/messina/Developer/dotfiles/claude/docs/solutions/workflow-issues/read-the-version-off-the-running-artifact-not-repo-master.md) — shares the primitive (ask the artifact, not the paperwork) but describes staleness between two points in time; here the doc and the runtime describe the same release and simply disagree.
- [`keyboard-conventions.md`](/Users/messina/Developer/GitHub/chrismessina/raycast-extension-workflows/plugins/raycast-extensions/reference/keyboard-conventions.md) — the operational half, and where the durable rule for answering a collision finding lives.
